    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!--Fix This--> 
                    <form:form class="form-horizontal" id="add-form" action="${pageContext.request.contextPath}/post/" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input id="published" name="published" type="date" placeholder="MM/DD/YYYY" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input id="expiration" name="expiration" type="date" placeholder="" class="form-control input-md">
